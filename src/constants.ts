export const mesonAddress = "0x25ab3efd52e6470681ce037cd546dc60726948d3";
export const baseApiUrl = "https://relayer.meson.fi/api/v1";
export const baseApiUrlForTest = "https://testnet-relayer.meson.fi/api/v1";
...
export const bridgeAggregatorInMultiChain: Record<string, string> = {
  ...
  bsc: "0xBD3D252269Ff174B7FA531a01e88fEe6c1C4a790",
};
